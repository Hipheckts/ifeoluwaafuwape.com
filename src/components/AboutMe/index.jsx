        ...
        <div className='personal-infos'>
          ...
          <div className='detail-wrapper'>
            <div className='details'>
              ...
              I am a UK-qualified Engineering Manager, Certified Google Professional Cloud Architect and Digital Leader, a full-stack software engineer(cloud, web, mobile) with over nine years of commercial experience across diverse sectors, including UK Higher Education, EdTech, FinTech, Agri-Tech, Health, E-commerce, and Fitness.<br />

My expertise lies in leading and architecting global technology solutions, intuitive and accessible web and mobile applications, ensuring they meet the highest standards of quality, scalability, and reliability. <br />

I possess strong problem-solving abilities, analytical thinking, attention to detail, and effective planning with several years of hands-on software engineering experience, excellent communication, managerial and collaborative skills to every team I have been privileged to be a part of with. My proven ability to thrive in multi-cultural and dynamic environments has enabled me to contribute significantly to achieving organizational goals.<br />
